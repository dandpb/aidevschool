...
import { parseDuracao, formatDuracao, mediaDuracoes } from '../src/duracao.js';
...
test('REQ-5: mediaDuracoes calcula a média das durações', () => {
  assert.equal(mediaDuracoes(['1h', '2h']), '1h30m');
  assert.equal(mediaDuracoes(['30m', '1h30m']), '1h');
});
