...
export const cycleStages: readonly CycleStage[] = [
  ...
  },
  {
    ...
    label: "Refatorar",
    owner: "Implementador",
    evidence: "mesmos testes e design melhor",
...
export const metrics: readonly Metric[] = [
  ...
  },
  {
    ...
    signal: "Mede autonomia e não volume de código gerado.",
  },
  {
    id: "correctness",
    label: "Corretude",
    target: "casos críticos cobertos",
    signal: "Confirma comportamento funcional e bordas.",
  },
  {
    id: "type-api-safety",
    label: "Segurança de tipos e API",
    target: "sem fugas não verificadas",
    signal: "Valida tipos estritos e contratos estáveis.",
  },
  {
    id: "security",
    label: "Segurança",
    target: "sem riscos conhecidos",
    signal: "Observa validação de entrada e limites de auth.",
  },
  {
    id: "operability",
    label: "Operabilidade e observabilidade",
    target: "logs, métricas e runbook",
    signal: "Mostra se o sistema é observável e reversível.",
  },
  {
    id: "benchmark-cv",
    label: "Variância do benchmark (CV%)",
    target: "CV <20%",
    signal: "Indica se a comparação é estável para confiança.",
  },
]
