  ...
  return `
    <section class="overview-grid" aria-label="Painel operacional">
      ...
      <article class="next-project">
        ...
        <button class="inline-link" type="button" data-project="${escapeHtml(model.currentProject.id)}" aria-label="Abrir briefing: ${escapeHtml(model.currentProject.title)}">Abrir briefing</button>
      </article>
