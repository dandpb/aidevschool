          ...
          .map(
            (project) => `
              <article class="project-card">
                ...
                <button class="inline-link" type="button" data-project="${escapeHtml(project.id)}" aria-label="Abrir briefing sobre ${escapeHtml(project.title)}">Abrir briefing</button>
              </article>
            `,
          )
          .join("")}
