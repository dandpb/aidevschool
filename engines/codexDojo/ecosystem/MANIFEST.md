...
| 18 | Product readiness and audience-first customer routes | `docs/design/product-readiness.md`, `docs/product-readiness/inventory.yaml`, `docs/product-readiness/scenarios/`, `docs/product-readiness/README.md`, `docs/product-readiness/student-guide.md`, `docs/product-readiness/facilitator-guide.md` |
