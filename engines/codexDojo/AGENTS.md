...
| OS bridge | `src/data/osEngine.ts`, `src/render/linuxLab.ts` | Configure with `VITE_CODEXDOJO_OS_URL`; production has no implicit remote URL. |
...
- Keep the compact Linux Lab as a compatibility simulator while
