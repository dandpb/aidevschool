...
| React design system | `design-system/AGENTS.md` | Separate package; wrappers over the dashboard CSS vocabulary. |
...
- Keep the `src/linuxLab/` module as a compact compatibility simulator while
