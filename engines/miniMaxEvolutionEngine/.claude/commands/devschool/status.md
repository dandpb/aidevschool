...
Estado atual do pipeline (`learner/pipeline_status.md`):
!`cat learner/pipeline_status.md 2>/dev/null || echo "(sem learner/pipeline_status.md)"`
...
4. Aponte qualquer bloqueio (`blockers`) ou inconsistência entre `learner/pipeline_status.md` e o learning gate.
