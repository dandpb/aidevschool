...
- Ao terminar, proponha ao orquestrador o avanço para `phase: benchmark-done, awaiting: optimization`; escreva
...
`grade=verified` e `advanced_by=/devschool-benchmark`. A entrega do produtor
