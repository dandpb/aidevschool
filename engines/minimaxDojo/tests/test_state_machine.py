...
`engines/minimaxDojo/core/state_machine.py`.
...
from engines.minimaxDojo.core.state_machine import DeterminismError, UnitStateMachine
...
class TestUnitStateMachine(unittest.TestCase):
    ...
    def test_new_unit_starts_in_apresentando(self):
        sm = UnitStateMachine(unit_id="U-001")
    ...
    def test_max_retries_is_configurable(self):
        ...
        sm = UnitStateMachine(unit_id="U-001", max_retries=1)
        sm.transition("aluno.aceita")
        sm.transition("aluno.submete")
