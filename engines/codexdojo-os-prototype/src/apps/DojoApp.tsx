  ...
  const units = [
    {
      ...
      subtitle: 'Dados, instruções e estado',
      state: 'done',
      icon: <Check />,
    },
    {
      title: 'Converse com o sistema',
      subtitle: 'Shell, comandos e processos',
      state: 'current',
      icon: <SquareTerminal />,
    },
    {
      title: 'Organize o conhecimento',
      subtitle: 'Arquivos, árvores e persistência',
      state: 'next',
      icon: <Folder />,
    },
    {
      title: 'Conecte as partes',
      subtitle: 'Redes, protocolos e eventos',
      state: 'locked',
      icon: <Network />,
    },
    {
      title: 'Construa com segurança',
      subtitle: 'Permissões, confiança e testes',
      state: 'locked',
      icon: <ShieldCheck />,
    },
  ]
        ...
        <header className="dojo-heading">
          <div>
            ...
            <div className="canonical-unit">
              ...
              <span>
                {learner.activeUnit.project} · retry {learner.activeUnit.retryCount}/
                {learner.activeUnit.retryLimit}
              </span>
            </div>
          </div>
          <div className="level-badge">
            <Award />
            <span>
              Nível 4<strong>Explorador</strong>
            </span>
          </div>
        </header>
        <div className="path-layout">
              ...
              <button
                ...
                onClick={() => {
                  onTeach({
                    ...
                    concepts: [
                      {
                        name: index === 1 ? 'Processo' : 'Modelo mental',
                        detail:
                          'Uma representação simples que ajuda a prever o comportamento do sistema.',
                      },
                      {
                        name: 'Evidência',
                        detail: 'Uma saída, teste ou explicação que comprova a aprendizagem.',
                      },
                    ],
                    challenge:
                      index === 1
                        ? 'Abra o Terminal e execute “learn process”.'
                        : 'Explique o conceito com suas palavras e aplique-o em um app.',
                  })
          ...
          <aside className="mission-card">
            ...
            <div className="mission-reward">
              <Star /> +40 XP <span>•</span> 1 conceito
            </div>
            <button type="button" className="primary-action" onClick={() => onOpenApp('terminal')}>
              <Play /> Começar missão
            </button>
          </aside>
        </div>
