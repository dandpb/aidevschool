      ...
      <div className="launcher-panel">
        <header>
          <div className="launcher-search">
            <Search />
            <input
              aria-label="Buscar aplicativos ou fundamentos"
              placeholder="Busque apps ou fundamentos…"
              value={query}
        ...
        <div className="launcher-body">
          <aside>
            ...
            <div className="catalog-summary">
              ...
              <small>{availableCount} disponíveis agora</small>
            </div>
          </aside>
