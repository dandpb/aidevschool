...
test('preserves completed first-release missions across switches and reloads', async ({ page }) => {
  ...
  // Wave O1 T2 (spec AID-610 rev 2 §2.2): l28 "Refatore com assistente sem
  // quebrar comportamento" follows as the 15th dev mission (chapterOrder 15,
  // canonical prereq l21 — completed above). Completes end-to-end through
  // choice, rubric_review, and output_comparison.
