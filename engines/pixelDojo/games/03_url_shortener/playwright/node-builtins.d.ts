...
// project deliberately ships without @types/node in the app code path (browser
// code must never touch Node APIs); the spec runs under the Playwright Node
// runtime, so these narrow declarations keep `tsc --noEmit` strict without
