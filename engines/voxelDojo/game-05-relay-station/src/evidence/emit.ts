...
const UNIT_ID = "U5-websocket-chat"
const PROJECT = "05_websocket_chat"
const GAME = "RELAY STATION"

export interface EvidenceRecord {
  source: "voxeldojo"
  unit_id: "U5-websocket-chat"
  project: "05_websocket_chat"
  scenario_id: `relay-station-${LevelId}`
  game: "RELAY STATION"
  ts: string
  pass: boolean
...
export function emitEvidence(
  ...
  const record: EvidenceRecord = {
    ...
    unit_id: UNIT_ID,
    project: PROJECT,
    scenario_id: `relay-station-${level}`,
    game: GAME,
