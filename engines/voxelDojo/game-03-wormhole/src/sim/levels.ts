...
export const LEVELS: readonly LevelConfig[] = [
  {
    id: "L1",
    title: "Portão de carimbo",
    lesson: "Uma URL é encurtada para um código base62. Preveja o código do portão.",
    seed: 11,
    urlCount: 6,
    strategy: "hash_trunc",
    forcedCollision: false,
    passRule: "Preveja o código base62 de ≥80% das URLs que chegam.",
  },
  {
    id: "L2",
    title: "Redirecionamento",
    lesson: "redirect(map, código) leva a viajante à URL de destino. Preveja o planeta de saída.",
    seed: 22,
    urlCount: 6,
    strategy: "hash_trunc",
    forcedCollision: false,
    passRule: "Preveja o planeta de destino de ≥80% dos códigos carimbados.",
  },
  {
    id: "L3",
    title: "Colisão",
  ...
  },
  {
    ...
    title: "Resolução",
    lesson:
      "Uma colisão é resolvida com re-salto (novo código) ou incremento (próximo código livre).",
    seed: 44,
    urlCount: 6,
    strategy: "hash_trunc",
    forcedCollision: true,
    passRule: "Escolha uma resolução que gere um código único e um wormhole limpo.",
  },
] as const
