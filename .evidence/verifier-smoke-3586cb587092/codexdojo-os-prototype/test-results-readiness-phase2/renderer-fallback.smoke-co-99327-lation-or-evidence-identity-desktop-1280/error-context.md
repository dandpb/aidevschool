...
- Name: renderer-fallback.smoke.spec.ts >> context loss degrades and retries without resetting simulation or evidence identity
- Location: tests/renderer-fallback.smoke.spec.ts:95:1
