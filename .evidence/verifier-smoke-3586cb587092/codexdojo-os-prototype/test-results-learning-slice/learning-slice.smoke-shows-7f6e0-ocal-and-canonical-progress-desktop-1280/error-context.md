...
- Name: learning-slice.smoke.spec.ts >> shows independent FAIL separately from local and canonical progress
- Location: tests/learning-slice.smoke.spec.ts:59:1
...
Locator: getByText('Verificação pede nova tentativa', { exact: true })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Verificação pede nova tentativa', { exact: true })
...
- main:
  ...
  - alert: "Evidência recusada: invalid-verifier-response"
  - paragraph:
    - link "WhatsApp":
