...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `dojotoday-daily-guidance` | dojoToday | `validated-journey` | `pass` | `validated-journey` | `2026-09-03T08:46:00+00:00` | `2026-10-03` | `2026-09-03T08:45:00Z-dojotoday-active-unit-guidance-mixed-0b8148e5`, `2026-09-03T08:45:00Z-dojotoday-read-only-boundary-observed-0b8148e5` | - | Read the current schedule, understand due reviews and the active unit, and follow the documented next action. |
