...
| `literacy-standalone-first-lesson` | literacyDojo | `customer-ready` | `conditional-follow-up` | `customer-ready` | `2026-08-22T15:15:00+00:00` | `2026-09-22` | `2026-08-22T15:13:00Z-literacy-happy-path-mixed-da2a1837`, `2026-08-22T15:13:00Z-literacy-retry-mixed-da2a1837`, `2026-08-22T15:13:00Z-literacy-resume-mixed-da2a1837` | dispositioned medium/low gaps remain | Complete an assigned lesson, recover from an incorrect attempt, and understand the local result. |
...
| `os-literacy-guided-mission` | codexDojo OS | `customer-ready` | `pass` | `customer-ready` | `2026-08-22T15:16:00+00:00` | `2026-09-22` | `2026-08-22T15:14:00Z-os-literacy-hosted-mission-mixed-da2a1837`, `2026-08-22T15:14:00Z-os-literacy-returning-device-mixed-da2a1837`, `2026-08-22T15:14:00Z-os-verification-recovery-mixed-da2a1837` | - | Choose an AI track, complete its hosted LiteracyDojo mission, and understand the host result and next action. |
| `os-returning-learner` | codexDojo OS | `customer-ready` | `stale` | `-` | `2026-08-21T21:00:00+00:00` | `2026-09-21` | `2026-08-21T20:59:14Z-os-onboarding-track-choice-mixed-c3cad96b`, `2026-08-21T20:59:14Z-os-returning-device-mixed-c3cad96b`, `2026-08-21T20:59:14Z-os-returning-recovery-mixed-c3cad96b` | scenario os-onboarding-track-choice source fingerprint is stale; scenario os-onboarding-track-choice artifact digest does not match: engines/codexdojo-os-prototype/tests-pilot/pilot-build.smoke.spec.ts; scenario os-returning-recovery source fingerprint is stale; scenario os-returning-recovery artifact digest does not match: engines/codexdojo-os-prototype/tests/readiness-recovery.smoke.spec.ts; scenario os-returning-device source fingerprint is stale; scenario os-returning-device artifact digest does not match: engines/codexdojo-os-prototype/tests/chapter-continuity.smoke.spec.ts | Resume the supported local OS state on the same device without repeating completed setup. |
| `os-voxel-guided-missions` | codexDojo OS | `customer-ready` | `stale` | `-` | `2026-08-21T21:00:00+00:00` | `2026-09-21` | `2026-08-21T20:59:14Z-os-renderer-accessibility-recovery-mixed-c3cad96b`, `2026-08-21T20:59:14Z-os-voxel-hosted-missions-mixed-c3cad96b`, `2026-08-21T20:59:14Z-os-voxel-returning-device-mixed-c3cad96b` | scenario os-voxel-hosted-missions source fingerprint is stale; scenario os-voxel-hosted-missions artifact digest does not match: engines/codexdojo-os-prototype/tests-pilot/pilot-build.smoke.spec.ts; scenario os-voxel-hosted-missions artifact digest does not match: engines/codexdojo-os-prototype/tests/dev-learning-slice.smoke.spec.ts; scenario os-renderer-accessibility-recovery source fingerprint is stale; scenario os-renderer-accessibility-recovery artifact digest does not match: engines/codexdojo-os-prototype/tests/renderer-fallback.smoke.spec.ts; scenario os-voxel-returning-device source fingerprint is stale; scenario os-voxel-returning-device artifact digest does not match: engines/codexdojo-os-prototype/tests/chapter-continuity.smoke.spec.ts | Launch each supported hosted voxelDojo mission and receive an accurate host status without a false mastery claim. |
