...
| `literacy-standalone-first-lesson` | literacyDojo | `customer-ready` | `stale` | `-` | `2026-09-03T19:31:00+00:00` | `2026-10-03` | `2026-09-03T19:26:00Z-literacy-happy-path-mixed-68a5f37c`, `2026-09-03T19:26:00Z-literacy-retry-mixed-68a5f37c`, `2026-09-03T19:26:00Z-literacy-resume-mixed-68a5f37c` | scenario literacy-happy-path source fingerprint is stale; scenario literacy-retry source fingerprint is stale; scenario literacy-resume source fingerprint is stale | Complete an assigned lesson, recover from an incorrect attempt, and understand the local result. |
