...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `dojotoday-daily-guidance` | dojoToday | `customer-ready` | `pass` | `customer-ready` | `2026-09-18T02:35:00+00:00` | `2026-10-18` | `2026-09-18T02:30:00Z-dojotoday-active-unit-guidance-mixed-3aca4d5d`, `2026-09-18T02:30:00Z-dojotoday-read-only-boundary-observed-3aca4d5d`, `2026-09-18T02:30:00Z-dojotoday-returning-next-day-mixed-3aca4d5d` | - | Read the current schedule, understand due reviews and the active unit, and follow the documented next action. |
