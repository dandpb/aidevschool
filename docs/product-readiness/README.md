...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `dojotoday-daily-guidance` | dojoToday | `customer-ready` | `pass` | `customer-ready` | `2026-09-09T02:45:00+00:00` | `2026-10-08` | `2026-09-09T02:40:00Z-dojotoday-active-unit-guidance-mixed-4234cebc`, `2026-09-09T02:40:00Z-dojotoday-read-only-boundary-observed-4234cebc`, `2026-09-09T02:40:00Z-dojotoday-returning-next-day-mixed-4234cebc` | - | Read the current schedule, understand due reviews and the active unit, and follow the documented next action. |
| `literacy-standalone-corridor-mod01-03` | literacyDojo | `customer-ready` | `pass` | `customer-ready` | `2026-09-09T02:45:00+00:00` | `2026-10-08` | `2026-09-09T02:42:33Z-literacy-corridor-grandfathered-return-4234cebc`, `2026-09-09T02:42:33Z-literacy-corridor-resume-mid-module-4234cebc`, `2026-09-09T02:40:00Z-literacy-corridor-happy-path-mixed-4234cebc`, `2026-09-09T02:40:00Z-literacy-corridor-gate-retry-mixed-4234cebc`, `2026-09-09T02:40:00Z-literacy-corridor-review-window-mixed-4234cebc` | - | Progress continuously through modules 1-3 (11 lessons), pass each module challenge, return for spaced reviews on the [1,7,21] schedule, and understand the local result and next action. |
| `literacy-standalone-first-lesson` | literacyDojo | `customer-ready` | `pass` | `customer-ready` | `2026-09-09T02:45:00+00:00` | `2026-10-08` | `2026-09-09T02:40:00Z-literacy-happy-path-mixed-4234cebc`, `2026-09-09T02:40:00Z-literacy-retry-mixed-4234cebc`, `2026-09-09T02:40:00Z-literacy-resume-mixed-4234cebc` | - | Complete an assigned lesson, recover from an incorrect attempt, and understand the local result. |
...
| `os-literacy-guided-mission` | codexDojo OS | `customer-ready` | `pass` | `customer-ready` | `2026-09-09T02:45:00+00:00` | `2026-10-08` | `2026-09-09T02:40:00Z-os-verification-recovery-mixed-4234cebc`, `2026-09-09T02:40:00Z-os-literacy-returning-device-mixed-4234cebc`, `2026-09-09T02:40:00Z-os-literacy-hosted-mission-mixed-4234cebc` | - | Choose an AI track, complete its hosted LiteracyDojo mission, and understand the host result and next action. |
| `os-returning-learner` | codexDojo OS | `customer-ready` | `pass` | `customer-ready` | `2026-09-09T02:45:00+00:00` | `2026-10-08` | `2026-09-09T02:40:00Z-os-onboarding-track-choice-mixed-4234cebc`, `2026-09-09T02:40:00Z-os-returning-recovery-mixed-4234cebc`, `2026-09-09T02:40:00Z-os-returning-device-mixed-4234cebc` | - | Resume the supported local OS state on the same device without repeating completed setup. |
| `os-voxel-guided-missions` | codexDojo OS | `customer-ready` | `pass` | `customer-ready` | `2026-09-09T02:45:00+00:00` | `2026-10-08` | `2026-09-09T02:40:00Z-os-voxel-hosted-missions-mixed-4234cebc`, `2026-09-09T02:40:00Z-os-renderer-accessibility-recovery-mixed-4234cebc`, `2026-09-09T02:40:00Z-os-voxel-returning-device-mixed-4234cebc` | - | Launch each supported hosted voxelDojo mission and receive an accurate host status without a false mastery claim. |
