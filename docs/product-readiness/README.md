...
| `minitown-explore-only` | miniTown | `experimental` | `stale` | `-` | `2026-08-20T22:22:00+00:00` | `2026-09-20` | `2026-08-20T21:10:00Z-minitown-explore-only-mixed-c8a961cf` | scenario minitown-explore-only source fingerprint is stale; scenario minitown-explore-only artifact digest does not match: engines/miniTown/README.md | Explore the local town simulation without a lesson, persistence, progression, evidence, or mastery promise. |
| `os-literacy-guided-mission` | codexDojo OS | `customer-ready` | `pass` | `customer-ready` | `2026-08-22T16:45:00+00:00` | `2026-09-22` | `2026-08-22T16:43:08Z-os-literacy-hosted-mission-mixed-d5787ce8`, `2026-08-22T16:43:08Z-os-literacy-returning-device-mixed-d5787ce8`, `2026-08-22T16:43:08Z-os-verification-recovery-mixed-d5787ce8` | - | Choose an AI track, complete its hosted LiteracyDojo mission, and understand the host result and next action. |
...
| `os-voxel-guided-missions` | codexDojo OS | `customer-ready` | `stale` | `-` | `2026-08-22T16:24:00+00:00` | `2026-09-22` | `2026-08-22T16:22:00Z-os-voxel-hosted-missions-mixed-2097723c`, `2026-08-22T16:22:00Z-os-renderer-accessibility-recovery-mixed-2097723c`, `2026-08-22T16:22:00Z-os-voxel-returning-device-mixed-2097723c` | scenario os-voxel-hosted-missions source fingerprint is stale; scenario os-renderer-accessibility-recovery source fingerprint is stale; scenario os-voxel-returning-device source fingerprint is stale | Launch each supported hosted voxelDojo mission and receive an accurate host status without a false mastery claim. |
