...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `dojotoday-daily-guidance` | dojoToday | `customer-ready` | `pass` | `customer-ready` | `2026-09-10T21:45:00+00:00` | `2026-10-08` | `2026-09-10T21:37:34Z-dojotoday-active-unit-guidance-mixed-80c3105f`, `2026-09-10T21:37:34Z-dojotoday-read-only-boundary-observed-80c3105f`, `2026-09-10T21:37:34Z-dojotoday-returning-next-day-mixed-80c3105f` | - | Read the current schedule, understand due reviews and the active unit, and follow the documented next action. |
...
| `os-literacy-guided-mission` | codexDojo OS | `customer-ready` | `pass` | `customer-ready` | `2026-09-13T17:40:00+00:00` | `2026-10-13` | `2026-09-13T17:37:14Z-os-literacy-hosted-mission-mixed-a6fb4813`, `2026-09-13T17:37:14Z-os-verification-recovery-mixed-a6fb4813`, `2026-09-13T17:37:14Z-os-literacy-returning-device-mixed-a6fb4813` | - | Choose an AI track, complete its hosted LiteracyDojo mission, and understand the host result and next action. |
| `os-returning-learner` | codexDojo OS | `customer-ready` | `pass` | `customer-ready` | `2026-09-11T23:05:00+00:00` | `2026-10-09` | `2026-09-11T22:40:24Z-os-onboarding-track-choice-mixed-bf00756a`, `2026-09-11T22:40:24Z-os-returning-device-mixed-bf00756a`, `2026-09-11T22:40:24Z-os-returning-recovery-mixed-bf00756a` | - | Resume the supported local OS state on the same device without repeating completed setup. |
