...
| `minitown-explore-only` | miniTown | `experimental` | `stale` | `-` | `2026-09-03T08:46:00+00:00` | `2026-10-03` | `2026-09-03T08:45:00Z-minitown-explore-only-mixed-0b8148e5` | scenario minitown-explore-only source fingerprint is stale; scenario minitown-explore-only artifact digest does not match: engines/miniTown/README.md | Explore the local town simulation without a lesson, persistence, progression, evidence, or mastery promise. |
