...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `dojotoday-daily-guidance` | dojoToday | `customer-ready` | `pass` | `customer-ready` | `2026-09-14T15:05:00+00:00` | `2026-10-14` | `2026-09-14T15:00:20Z-dojotoday-active-unit-guidance-mixed-e716df98`, `2026-09-14T15:00:20Z-dojotoday-read-only-boundary-observed-e716df98`, `2026-09-14T15:00:20Z-dojotoday-returning-next-day-mixed-e716df98` | - | Read the current schedule, understand due reviews and the active unit, and follow the documented next action. |
...
| `minitown-explore-only` | miniTown | `experimental` | `pass` | `experimental` | `2026-09-14T18:45:00+00:00` | `2026-10-14` | `2026-09-14T18:43:12Z-minitown-explore-only-mixed-650bcfdc` | - | Explore the local town simulation without a lesson, persistence, progression, evidence, or mastery promise. |
...
| `os-voxel-guided-missions` | codexDojo OS | `customer-ready` | `pass` | `customer-ready` | `2026-09-14T15:05:00+00:00` | `2026-10-14` | `2026-09-14T15:00:20Z-os-voxel-hosted-missions-mixed-e716df98`, `2026-09-14T15:00:20Z-os-renderer-accessibility-recovery-mixed-e716df98`, `2026-09-14T15:00:20Z-os-voxel-returning-device-mixed-e716df98` | - | Launch each supported hosted voxelDojo mission and receive an accurate host status without a false mastery claim. |
| `pixelquest-evidence-encounter` | PixelQuest | `customer-ready` | `pass` | `customer-ready` | `2026-09-14T18:45:00+00:00` | `2026-10-14` | `2026-09-14T18:43:12Z-pixelquest-encounter-evidence-mixed-650bcfdc`, `2026-09-14T18:43:12Z-pixelquest-evidence-recovery-observed-650bcfdc`, `2026-09-14T18:43:12Z-pixelquest-returning-evidence-handoff-mixed-650bcfdc` | - | Complete a documented encounter, locate its raw evidence, and hand it to the independent verifier. |
| `voxel-standalone-learning-loop` | voxelDojo | `customer-ready` | `pass` | `customer-ready` | `2026-09-14T15:05:00+00:00` | `2026-10-14` | `2026-09-14T15:00:20Z-voxel-standalone-loop-mixed-e716df98`, `2026-09-14T15:00:20Z-voxel-accessible-renderer-observed-e716df98`, `2026-09-14T15:00:20Z-voxel-standalone-return-reentry-mixed-e716df98` | - | Complete the deterministic loop in each declared standalone game and locate raw evidence for independent verification. |
