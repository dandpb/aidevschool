...
| `os-literacy-guided-mission` | codexDojo OS | `customer-ready` | `stale` | `-` | `2026-08-22T15:16:00+00:00` | `2026-09-22` | `2026-08-22T15:14:00Z-os-literacy-hosted-mission-mixed-da2a1837`, `2026-08-22T15:14:00Z-os-literacy-returning-device-mixed-da2a1837`, `2026-08-22T15:14:00Z-os-verification-recovery-mixed-da2a1837` | scenario os-literacy-hosted-mission source fingerprint is stale; scenario os-literacy-hosted-mission artifact digest does not match: engines/codexdojo-os-prototype/tests-pilot/pilot-build.smoke.spec.ts; scenario os-verification-recovery source fingerprint is stale; scenario os-verification-recovery artifact digest does not match: engines/codexdojo-os-prototype/tests-pilot/pilot-build.smoke.spec.ts; scenario os-literacy-returning-device source fingerprint is stale | Choose an AI track, complete its hosted LiteracyDojo mission, and understand the host result and next action. |
| `os-returning-learner` | codexDojo OS | `customer-ready` | `conditional-follow-up` | `customer-ready` | `2026-08-22T16:24:00+00:00` | `2026-09-22` | `2026-08-22T16:22:00Z-os-onboarding-track-choice-mixed-2097723c`, `2026-08-22T16:22:00Z-os-returning-device-mixed-2097723c`, `2026-08-22T16:22:00Z-os-returning-recovery-mixed-2097723c` | dispositioned medium/low gaps remain | Resume the supported local OS state on the same device without repeating completed setup. |
| `os-voxel-guided-missions` | codexDojo OS | `customer-ready` | `pass` | `customer-ready` | `2026-08-22T16:24:00+00:00` | `2026-09-22` | `2026-08-22T16:22:00Z-os-voxel-hosted-missions-mixed-2097723c`, `2026-08-22T16:22:00Z-os-renderer-accessibility-recovery-mixed-2097723c`, `2026-08-22T16:22:00Z-os-voxel-returning-device-mixed-2097723c` | - | Launch each supported hosted voxelDojo mission and receive an accurate host status without a false mastery claim. |
