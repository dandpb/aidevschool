...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `dojotoday-daily-guidance` | dojoToday | `customer-ready` | `pass` | `customer-ready` | `2026-09-16T23:00:00+00:00` | `2026-10-16` | `2026-09-16T22:55:00Z-dojotoday-active-unit-guidance-mixed-cabdc4a1`, `2026-09-16T22:55:00Z-dojotoday-read-only-boundary-observed-cabdc4a1`, `2026-09-16T22:55:00Z-dojotoday-returning-next-day-mixed-cabdc4a1` | - | Read the current schedule, understand due reviews and the active unit, and follow the documented next action. |
