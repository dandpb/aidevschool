...
| LiteracyDojo avulso | `https://aidevschool-literacydojo.netlify.app/` | Entrada pública de aprendiz (14 missões IA Prática, pt-BR) | `npm run build`; functions do dir canônico `learner/gate/netlify-functions` |
