...
## 2026-08-14 - Pre-compute Static State for findIndex
**Learning:** Using `.findIndex` inside render/update loops for static configuration arrays causes O(N) array scans.
**Action:** Pre-compute a `Map` at module initialization time for O(1) lookups.
