...
| # | Passo | Arquivo |
| --- | --- | --- |
| P1 | Adicionar bloco OG/Twitter à literacy: `og:title`, `og:description`, `og:type=website`, `og:site_name`, `og:locale=pt_BR`, `og:url`, `og:image=/icon-512.png`, `twitter:card=summary` — copy verbatim do `<title>`/`<description>` atuais | `engines/literacyDojo/index.html` |
| P2 | Idem no OS: `og:image=/dojo-wallpaper.png`, `twitter:card=summary_large_image` — copy verbatim | `engines/codexdojo-os-prototype/index.html` |
