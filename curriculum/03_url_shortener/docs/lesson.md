...
> **Cycle:** 03_url_shortener · **Generated:** 2026-07-02 · **Levels:** intuition → formal → practical
> DoD §7: *"lesson.md explains the concept at 3 levels (intuition, formal, practical)."*

## Overview

Build a small HTTP URL shortener that accepts long URLs, creates compact short codes, redirects visitors to the original URL, and records click analytics without slowing down redirects.



## 1. Intuition

URL Shortener is a deceptively simple system whose difficulty lives in the edges: deterministic
