# ADR-0001: Core architecture for Metrics Collector & Dashboard

> **Cycle:** 15_metrics_collector · **Generated:** 2026-07-02 · **Format:** MADR
> DoD §7: *"ADR.md (Architecture Decision Record) if there is a new decision."*

## Context and Problem Statement

Metrics Collector & Dashboard must be implemented in go, rust, node with behavioral equivalence so that tests,
