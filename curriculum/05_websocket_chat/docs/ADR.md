# ADR-0001: Core architecture for WebSocket Chat Server

> **Cycle:** 05_websocket_chat · **Generated:** 2026-07-02 · **Format:** MADR
> DoD §7: *"ADR.md (Architecture Decision Record) if there is a new decision."*

## Context and Problem Statement

WebSocket Chat Server must be implemented in go, rust, node with behavioral equivalence so that tests,
