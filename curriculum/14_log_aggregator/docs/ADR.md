# ADR-0001: Core architecture for Log Aggregator

> **Cycle:** 14_log_aggregator · **Generated:** 2026-07-02 · **Format:** MADR
> DoD §7: *"ADR.md (Architecture Decision Record) if there is a new decision."*

## Context and Problem Statement

Log Aggregator must be implemented in go, rust, node with behavioral equivalence so that tests,
