# ADR-0001: Core architecture for REST API with Auth

> **Cycle:** 07_rest_api_auth · **Generated:** 2026-07-02 · **Format:** MADR
> DoD §7: *"ADR.md (Architecture Decision Record) if there is a new decision."*

## Context and Problem Statement

REST API with Auth must be implemented in go, rust, node with behavioral equivalence so that tests,
