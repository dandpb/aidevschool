# Lesson: Key-Value Store

> **Cycle:** 02_key_value_store · **Generated:** 2026-07-02 · **Levels:** intuition → formal → practical
> DoD §7: *"lesson.md explains the concept at 3 levels (intuition, formal, practical)."*

## Overview

This project builds a single-node, in-memory key-value store with a small HTTP API.



## 1. Intuition

Key-Value Store is a deceptively simple system whose difficulty lives in the edges: deterministic
