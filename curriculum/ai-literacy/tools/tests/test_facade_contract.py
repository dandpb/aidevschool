...
class TestFacade(TrackFixtureMixin):
    ...
    def test_direct_script_success_and_compile_output(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(
                "OK: 27 lição(ões) ready validadas: 20 IA na Prática, 7 Dev; "
                "2 planned (sem arquivo exigido).\n"
    ...
    def test_direct_script_bootstrap_and_entrypoint(self):
        ...
        self.assertTrue(stdout.getvalue().startswith("OK: 27 lição(ões) ready validadas"))
