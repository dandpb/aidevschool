...
class TestFacade(TrackFixtureMixin):
    ...
    def test_direct_script_success_and_compile_output(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(
                "OK: 19 lição(ões) ready validadas: 16 IA na Prática, 3 Dev; "
                "1 planned (sem arquivo exigido).\n"
    ...
    def test_direct_script_bootstrap_and_entrypoint(self):
        ...
        self.assertTrue(stdout.getvalue().startswith("OK: 19 lição(ões) ready validadas"))
