...
def _catalog_entries(catalog, ready_lessons):
...
def _modules_payload(catalog, entries):
    modules_payload = []
...
def _render_content(catalog, ready_lessons):
    entries = _catalog_entries(catalog, ready_lessons)
    modules_payload = _modules_payload(catalog, entries)
