...
> **Cycle:** 11_load_balancer · **Generated:** 2026-07-02 · **Levels:** intuition → formal → practical
> DoD §7: *"lesson.md explains the concept at 3 levels (intuition, formal, practical)."*

## Overview

Build a language-neutral Layer 7 HTTP/HTTPS load balancer in Go, Rust, and Node.js/TypeScript.



## 1. Intuition

Load Balancer is a deceptively simple system whose difficulty lives in the edges: deterministic
